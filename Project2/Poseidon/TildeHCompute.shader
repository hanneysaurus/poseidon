...
uniform readonly layout(binding = 3, rgba8) image2D randtex1;
uniform readonly layout(binding = 4, rgba8) image2D randtex2;
uniform readonly layout(binding = 5, rgba8) image2D randtex3;
uniform readonly layout(binding = 6, rgba8) image2D randtex4;
